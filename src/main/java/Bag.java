...
public abstract class Bag {
    ...
    public boolean addItem(String item) {
        ...
        if (numItems < this.capacity) {
            this.contents[numItems] = item;
    ...
    public String popItem() {
        ...
        if (numItems == 0) {
            ...
            String item = this.contents[numItems - 1];
            this.contents[numItems - 1] = null;
            this.numberOfContents -= 1;
            return item;
        }
    }
     ...
     *
     * @return Return color, numberOfContents, and capacity formatted
     */
    @Override
